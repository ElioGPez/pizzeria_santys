  ...
  <div class="content">
        ...
        <div class="col-6">
          ...
          >
            <template slot="header">
              <h4 class="card-title">PEDIDOS POR MESAS</h4>
            </template>
        ...
        <div class="col-6">
          ...
          >
            ...
            <div>
              ...
              <div class="col-12 subtitulo mt-3">PRODUCTOS</div>
              <div class="row mb-2">
                <div class="col-8">
                  <ProModal />
                </div>
                ...
                <div class="row pt-4 pr-2">
                  <div class="col-4 pr-1" align="center">
                    <button @click="cantidad--" class="btn btn-warning btn-cantidad">
                      -
                    </button>
                  </div>
                  <div class="col-4 p-0">
    ...
    >
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div align="center" class="modal-header">
            <div class="col-12"><h3 style="color: white">Detalles de envio</h3></div>
          </div>
          <div class="modal-body">
            <div class="row">
              <div align="center" class="col-4 pt-2">
